# # this is a coding challenge I completed a long while back, re-completed in python
...
def candles():
    a = input("Enter number of candles: ")
    b = input("Enter candle heights, seperated by spaces: ")
    l = b.split(" ")
    blow = []
    for candle in b:
        if max(b) is candle:
